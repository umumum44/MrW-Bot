...
module.exports.run = async (bot, message, args) => {
	if(message.author.id === "399975738008141824" || message.author.id === "303683211790254080" || message.author.id === "294990053849956354" || message.author.id === "303683211790254080" || message.author.id === "335096822194241537") {
